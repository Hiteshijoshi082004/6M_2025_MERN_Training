    ...
    return(
        ...
        {data.map((el,index)=>(
            <>
                <tr key={index}>
                    <td>{index+1}.</td>
                    <td><strong>{el.info.name}</strong></td>
                    <td><img src={el.info.image.urlWithParams} alt={el.info.name} style={{height:"200px" , width:"200px", display:"block", marginLeft:"auto", marginRight:"auto"}} /></td>
                    <td><h5>{el.info.rating.rating_text}</h5></td>   
                </tr>
